...
import 'mobile_article_body_right_pane.dart';

class MobileDetailedArticleScreen extends StatefulWidget {
  final HiveArticleData? data;
  final docId;
  const MobileDetailedArticleScreen({Key? key, this.data, this.docId})
      : super(key: key);

  @override
  _MobileDetailedArticleScreenState createState() =>
      _MobileDetailedArticleScreenState();
}

class _MobileDetailedArticleScreenState
    extends State<MobileDetailedArticleScreen> {
