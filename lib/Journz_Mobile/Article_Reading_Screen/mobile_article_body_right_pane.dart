...
import '../HomePage/mobile_home_page_footer.dart';
...
class MobileArticleBodyRightPane extends StatefulWidget {
  final HiveArticleData? data;
  final docId;
  const MobileArticleBodyRightPane({Key? key, required this.docId, this.data})
      : super(key: key);

  @override
  _MobileArticleBodyRightPaneState createState() =>
      _MobileArticleBodyRightPaneState();
}

class _MobileArticleBodyRightPaneState
    extends State<MobileArticleBodyRightPane> {
                                                      ...
                                                      articleState.hiveArticleData!
                                                          ...
                                                          : articleState.hiveArticleData!.noOfComments >=
                                                                  ...
                                                                  articleState
                                                                          ...
                                                                          .noOfComments <=
                                                                      999999999
                                                              ? Text((articleState.hiveArticleData!.noOfComments / 1000000)
                                                                      .floor()
                                                                      .toString() +
                                                                  "M")
                                                              : Text(articleState
                                                                  ...
                                                                  context.vxNav.push(
                                                                      ...
                                                                      params: {
                                                                        ...
                                                                        "articleData": CodeArticleData(
                                                                            articleDescription:
                                                                                articleState.hiveArticleData!.articleDescription,
