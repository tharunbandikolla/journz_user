...
class MobileDrawer extends StatefulWidget {
  ...
  final Function(bool) showFAvCategory;
  const MobileDrawer(
      {Key? key, required this.userState, required this.showFAvCategory})
      : super(key: key);
                ...
                AnimatedContainer(
                  ...
                  child: Column(children: [
                    ...
                    /* ElevatedButton(
                                          ...
                                          child: Text("Test")), */
                    BlocBuilder<NotificationonoffCubit, NotificationonoffState>(
