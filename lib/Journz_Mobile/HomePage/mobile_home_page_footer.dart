...
class MobileHomePageFooter extends StatefulWidget {
  const MobileHomePageFooter({Key? key}) : super(key: key);

  @override
  _MobileHomePageFooterState createState() => _MobileHomePageFooterState();
}

class _MobileHomePageFooterState extends State<MobileHomePageFooter> {
  @override
