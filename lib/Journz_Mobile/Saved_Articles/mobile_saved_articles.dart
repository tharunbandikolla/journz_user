...
class MobileShowSavedArticles extends StatefulWidget {
  const MobileShowSavedArticles({Key? key}) : super(key: key);

  @override
  _MobileShowSavedArticlesState createState() =>
      _MobileShowSavedArticlesState();
}

class _MobileShowSavedArticlesState extends State<MobileShowSavedArticles> {
