...
class MobileShowArticlesUnderReview extends StatefulWidget {
  const MobileShowArticlesUnderReview({Key? key}) : super(key: key);

  @override
  _MobileShowArticlesUnderReviewState createState() =>
      _MobileShowArticlesUnderReviewState();
}

class _MobileShowArticlesUnderReviewState
    extends State<MobileShowArticlesUnderReview> {
