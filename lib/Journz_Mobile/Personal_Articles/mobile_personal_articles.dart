...
class MobileShowPersonalArticles extends StatefulWidget {
  const MobileShowPersonalArticles({Key? key}) : super(key: key);

  @override
  _MobileShowPersonalArticlesState createState() =>
      _MobileShowPersonalArticlesState();
}

class _MobileShowPersonalArticlesState
    extends State<MobileShowPersonalArticles> {
