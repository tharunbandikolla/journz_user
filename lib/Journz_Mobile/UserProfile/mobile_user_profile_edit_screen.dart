...
class MobileUserProfileEditScreen extends StatefulWidget {
  final CheckuserloginedState? userState;
  const MobileUserProfileEditScreen({Key? key, required this.userState})
      : super(key: key);

  @override
  State<MobileUserProfileEditScreen> createState() =>
      _MobileUserProfileEditScreenState();
}

class _MobileUserProfileEditScreenState
    extends State<MobileUserProfileEditScreen> {
                ...
                child: Column(children: [
                  ...
                  Container(
                      ...
                      child: Column(children: [
                        ...
                        Container(
                          //height: context.screenWidth * 0.93,
                          width: context.screenWidth,
                          child: Column(
                              mainAxisAlignment: MainAxisAlignment.spaceEvenly,
                              ...
                              children: [
                                Column(
                                      ...
                                      EditUserDataInRow(
                                          left: "Gender",
                                          right: BlocBuilder<PassGenderCubit,
                                              PassGenderState>(
                                            builder: (context, genderState) {
                                              genderController.text =
                                                  genderState.genderdata!;
                                              return DropdownButton<String>(
                                                value: genderState.genderdata,
                                                items: <String>[
                                                  'Male',
                                                  'Female',
                                                  'Neutral',
...
//                                    .height(context.screenWidth * 0.325)
                                ...
                                Column(
                                      ...
                                      EditUserDataInRow(
                                          left: "Marital Status",
                                          right: BlocBuilder<MaritalStatusCubit,
                                              MaritalStatusState>(
...
//                                    .height(context.screenWidth * 0.325)
                                ...
                                Column(
                                    ...
                                    ]).box.p8.width(context.screenWidth).make(),
                                Column(
                                        mainAxisAlignment: MainAxisAlignment.start,
                                        crossAxisAlignment:
                                            CrossAxisAlignment.start,
  ...
  Widget build(BuildContext context) {
    return Row(
      ...
      children: [
        ...
        right.box.alignTopLeft.width(context.screenWidth * 0.55).make(),
      ],
    )
        .box
...
class UserDataInRowInEdit extends StatelessWidget {
  final String left, right;
  const UserDataInRowInEdit({Key? key, required this.left, required this.right})
      : super(key: key);
