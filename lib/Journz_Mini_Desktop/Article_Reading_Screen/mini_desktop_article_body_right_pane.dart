...
import '../../Journz_Tab/tab_home_footer.dart';
...
class MiniDesktopArticleBodyRightPane extends StatefulWidget {
  final HiveArticleData? data;
  final docId;
  const MiniDesktopArticleBodyRightPane(
      {Key? key, required this.docId, this.data})
      : super(key: key);

  @override
  _MiniDesktopArticleBodyRightPaneState createState() =>
      _MiniDesktopArticleBodyRightPaneState();
}

class _MiniDesktopArticleBodyRightPaneState
    extends State<MiniDesktopArticleBodyRightPane> {
                                                          ...
                                                          children: [
                                                            ...
                                                            articleState.hiveArticleData!
                                                                ...
                                                                ? Text((articleState.hiveArticleData!.noOfViews /
                                                                        ...
                                                                        .toString() +
                                                                    "K")
                                                                : articleState.hiveArticleData!.noOfViews >=
                                                                            1000000 &&
                                                                        articleState.hiveArticleData!.noOfViews <=
                                                                            999999999
                                                                    ? Text((articleState.hiveArticleData!.noOfViews /
                                                          ...
                                                          children: [
                                                            ...
                                                            articleState.hiveArticleData!
                                                                ...
                                                                ? Text((articleState.hiveArticleData!.noOfComments /
                                                                        ...
                                                                        .toString() +
                                                                    "K")
                                                                : articleState.hiveArticleData!.noOfComments >=
                                                                            1000000 &&
                                                                        articleState.hiveArticleData!.noOfComments <=
                                                                            999999999
                                                                    ? Text((articleState.hiveArticleData!.noOfComments /
                                                            ...
                                                            children: [
                                                              ...
                                                              articleState.hiveArticleData!
                                                                  ...
                                                                  ? Text((articleState.hiveArticleData!.noOflikes /
                                                                          ...
                                                                          .toString() +
                                                                      "K")
                                                                  : articleState.hiveArticleData!.noOflikes >=
                                                                              1000000 &&
                                                                          articleState.hiveArticleData!.noOflikes <=
                                                                              999999999
                                                                      ? Text((articleState.hiveArticleData!.noOflikes / 1000000)
                                                                              .floor()
                                                                              .toString() +
                                                                          "M")
                                                                      : Text(articleState
                                                              ...
                                                              if (currentPressedTime ==
                                                                ...
                                                                if (loginState
                                                                  ...
                                                                  if (widget
                                                                    ...
                                                                    }).whenComplete(() => context.read<BookmarkarticlesCubit>().listenForBookmark(
                                                                            loginState.userUid!,
                                                                            widget.docId));
                                                                  }
                                                                } else {
                                                                      ...
                                                                      InkWell(
                                                                          onTap:
                                                                            ...
                                                                            context.vxNav.push(
                                                                                ...
                                                                                params: {
                                                                                  'isEditArticle': true,
                                                                                  "articleData": CodeArticleData(articleDescription: articleState.hiveArticleData!.articleDescription, articleLike: articleState.hiveArticleData!.articleLike, articlePhotoUrl: articleState.hiveArticleData!.articlePhotoUrl, articleReportedBy: articleState.hiveArticleData!.articleReportedBy, articleSubtype: articleState.hiveArticleData!.articleSubtype, articleTitle: articleState.hiveArticleData!.articleTitle, authorName: articleState.hiveArticleData!.authorName, authorUid: articleState.hiveArticleData!.authorUid, bookmarkedBy: articleState.hiveArticleData!.bookmarkedBy, country: articleState.hiveArticleData!.country, documentId: articleState.hiveArticleData!.documentId, galleryImages: articleState.hiveArticleData!.galleryImages, isArticlePublished: articleState.hiveArticleData!.isArticlePublished, isArticleReported: articleState.hiveArticleData!.isArticleReported, noOfComments: articleState.hiveArticleData!.noOfComments, noOfViews: articleState.hiveArticleData!.noOfViews, noOflikes: articleState.hiveArticleData!.noOflikes, socialMediaLink: articleState.hiveArticleData!.socialMediaLink)
                                                                                });
                                                                          },
                                                                          child: Image.asset(
