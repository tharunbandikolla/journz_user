...
class ArticlesDetailViewScreenNew extends StatefulWidget {
  ...
  @override
  _ArticlesDetailViewScreenNewState createState() =>
      _ArticlesDetailViewScreenNewState();
}

class _ArticlesDetailViewScreenNewState
    extends State<ArticlesDetailViewScreenNew> {
  ...
  void initState() {
    ...
    getPrefs();
    localLikeNos = int.parse(widget.articlesModel.noOfLike!);
    likedList = widget.articlesModel.peopleLike;
    super.initState();
  }
  ...
  Widget build(BuildContext context) {
    ...
    final cubit = BlocProvider.of<StaticarticlelikeCubit>(context);
    cubit.getInitialstate(int.parse(widget.articlesModel.noOfLike!),
        widget.articlesModel.peopleLike!);
        ...
        onWillPop: () async {
          ...
          if (widget.fromNotification) {
            ...
            FirebaseFirestore.instance
                ...
                .doc(widget.documentId)
                .update({
              'NoOfLikes': '${localLikeNos ?? 0}',
              'ArticleLike': likedList ?? []
            });
          }
                                                      ...
                                                      child: Row(
                                                        mainAxisAlignment:
                                                            MainAxisAlignment
                                                                .spaceBetween,
                                                        children: [
                                                          Text('Views : ${widget.articlesModel.noOfViews}')
                                                              .text
                                                              .bold
                                                              .make(),
                                                          Text(
                                                              'Author - ${widget.articlesModel.authorName}',
                                                              style: TextStyle(
                                                                  color: Colors
                                                                      .red,
                                                                  fontSize:
                                                                  ...
                                                                  itemBuilder:
                                                                    ...
                                                                    return index ==
                                                                        ...
                                                                        ? InkWell(
                                                                            onTap:
                                                                                () {
                                                                              Navigator.push(context, MaterialPageRoute(builder: (context) => GalleryImageViewScreen(gallery: widget.articlesModel.galleryImages!)));
                                                                            },
                                                                            child:
                                                                                Container(
                                                                        ...
                                                                        : Container(
                                                                            margin:
                                                                                EdgeInsets.symmetric(horizontal: context.screenWidth * 0.007),
                                                                            decoration:
                                                                                BoxDecoration(image: DecorationImage(image: CachedNetworkImageProvider(widget.articlesModel.galleryImages![index]['GalleryImageUrl']), fit: BoxFit.fill)),
                                                                          );
                                                                  })
                                                            ],
                                                          ),
                                                                              ...
                                                                              onPressed: () {
                                                                                if (FirebaseAuth.instance.currentUser?.uid != null) {
                                                                                  if (FirebaseAuth.instance.currentUser!.emailVerified) {
                                                                                    state.isLiked! ? cubit.disLikeArticle(localLikeNos, widget.articlesModel.peopleLike, widget.documentId) : cubit.likedArticle(localLikeNos, widget.articlesModel.peopleLike, widget.documentId);
                                                                                  } else {
