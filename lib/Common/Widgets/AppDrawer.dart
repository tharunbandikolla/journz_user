...
// import '/Authentication/Screens/InitialAccountSelection.dart';
...
// import '/Common/Screens/SettingsScreen.dart';
...
//                                                                                     BlocProvider(create: (context) => AddphotoarticleCubit()),
//                                                                                   ],
//                                                                                   child: ArticleUnderReviewScreen(),
//                                                                                 )))
//                                                                 : Navigator.push(
//                                                                     context,
//                                                                     MaterialPageRoute(
...
//                             });
//                           },
//                           child: Text('Update UserDb')), */
//                       /* ElevatedButton(
//                           onPressed: () async {
//                             QuerySnapshot q = await FirebaseFirestore.instance
//                                 .collection('CheckCollection')
//                                 .where('subtype', isEqualTo: 'sports')
//                                 .where('check',
//                                     arrayContainsAny: ['All']).get();
//                             print('nnn number of  docs ${q.size}');
//                           },
//                           child: Text('bbbb')), */
//                     ]),
//               ),
