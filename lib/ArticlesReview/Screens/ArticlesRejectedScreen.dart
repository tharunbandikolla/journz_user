...
class ArticlesRejectedScreen extends StatefulWidget {
  const ArticlesRejectedScreen({Key? key}) : super(key: key);

  @override
  _ArticlesRejectedScreenState createState() => _ArticlesRejectedScreenState();
}

class _ArticlesRejectedScreenState extends State<ArticlesRejectedScreen> {
  @override
  void initState() {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: 'Articles Rejected'.text.bold.make(),
      ),
      body: Container(
