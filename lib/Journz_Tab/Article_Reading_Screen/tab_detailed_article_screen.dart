...
import '../../Journz_Mobile/Article_Reading_Screen/mobile_article_body_right_pane.dart';
...
import 'tab_article_body_right_pane.dart';

class TabDetailedArticleScreen extends StatefulWidget {
  final HiveArticleData? data;
  final docId;
  const TabDetailedArticleScreen({Key? key, this.data, this.docId})
      : super(key: key);

  @override
  _TabDetailedArticleScreenState createState() =>
      _TabDetailedArticleScreenState();
}

class _TabDetailedArticleScreenState extends State<TabDetailedArticleScreen> {
