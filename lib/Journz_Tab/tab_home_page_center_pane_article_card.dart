...
class TabHomePageCenterPaneArticleCard extends StatefulWidget {
  final List<HiveArticleData> listOfArticles;
  final int index;

  const TabHomePageCenterPaneArticleCard(
...
class _HomePageCenterPaneArticleCardState
    extends State<TabHomePageCenterPaneArticleCard> {
  @override
      ...
      return Column(
        ...
        children: [
          ...
          Text(
            ...
            //  overflow: TextOverflow.ellipsis,
            maxLines:
                listOfArticles[index].articlePhotoUrl != 'WithoutImage' ? 5 : 5,
          ),
          ...
          .width(listOfArticles[index].articlePhotoUrl != 'WithoutImage'
              ? (context.screenWidth * 0.9 - 80) * 0.7
              : (context.screenWidth * 0.9 - 80) * 0.90)
...
Widget postimage(String articlePhotoUrl) {
  return Builder(builder: (context) {
    return Image.network(articlePhotoUrl,
        ...
        .box
        .height(context.screenHeight * 0.2)
        .width((context.screenWidth * 0.9 - 80) * 0.2)
        .make();
  });
}
