...
class ShowPersonalArticles extends StatefulWidget {
  const ShowPersonalArticles({Key? key}) : super(key: key);

  @override
  _ShowPersonalArticlesState createState() => _ShowPersonalArticlesState();
}

class _ShowPersonalArticlesState extends State<ShowPersonalArticles> {
